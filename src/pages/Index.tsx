...
const services = [
  ...
  { icon: "🗞️", title: "Поклейка обоев", desc: "Ровно, красиво, без пузырей — честно-честно!", color: "#FF3B3B", text: "#fff" },
  { icon: "🏗️", title: "Капитальный ремонт", desc: "От А до Я. Принимаем руины, сдаём конфетку.", color: "#2979FF", text: "#fff" },
  { icon: "📐", title: "Дизайн-проект", desc: "Нарисуем как будет выглядеть — до начала ремонта!", color: "#00C853", text: "#fff" },
